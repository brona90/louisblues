...
EXERCISE = {
    ...
    "sections": [
        {
            ...
            "cards": [
                ...
                make_card("Box 3", "Blues scale — Box 3 (fret 4)",
                          ...
                          BOX3, (4, 8),
                          "The middle of the neck. The classic blues move lives here: bend the B♭ (♭5) on string 1 fret 6 up a half-step to the 5 (B) — or use the B♭ on string 4 fret 8 as a passing tone.", box_n=3),
                make_card("Box 4", "Blues scale — Box 4 (fret 7)",
                          "♭5 on string 4 fret 8, string 2 fret 11",
                          BOX4, (7, 11),
                          "Box 4 holds the king bend: bend the G (♭3, string 2 fret 8) up half-step toward G♯ — that's the ♭3/3 oscillation that defines the sound.", box_n=4),
    ...
    "next_step": {
        ...
        "items": [
            ...
            ("4 min", "In Box 4, bend the G on string 2 fret 8 up a half-step to G♯. Release. Bend again. That's the sound."),
